...
class ModelNetDataLoader(Dataset):
    ...
    Args:
        ...
        10:
            ...
            908 test
    """
    def __init__(self, root, npoint=1024, split='train', uniform=False, 
...
class PartNormalDataset(Dataset):
    def __init__(self, root='./data/shapenetcore_partanno_segmentation_benchmark_v0_normal', npoints=1024, split='train', class_choice=None, normal_channel=False):

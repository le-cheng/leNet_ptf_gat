...
if __name__ == '__main__':
    ...
    parser.add_argument('--ballradius', type=int, default=5, help='ballradius')
    ...
    ModelNetDataLoader = getattr(importlib.import_module('dataset1'), 'ModelNetDataLoader')
    root = '../data/modelnet40_normal_resampled'
    dataset = ModelNetDataLoader(root = root, npoint=2048, split='test', normal_channel=False)
